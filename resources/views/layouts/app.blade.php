...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm" style="background-color: #00FF5C!important;">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        @else
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="nav-item"><a class="nav-link" href="{{route('year.index')}}">Year</a></li>
